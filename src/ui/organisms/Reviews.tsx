	...
	return (
		<div className="max-w-2xl lg:grid lg:max-w-full lg:grid-cols-12 lg:gap-x-8 lg:py-16">
			<div className="lg:col-span-4">
				<h2 className="my-4 w-fit text-2xl font-extrabold">Customer Reviews</h2>
				<div className="mt-3 flex items-center">
					<Rating rating={product.rating || 0} />
					<p className="ml-2 text-xs text-gray-900">Based on {reviews.length} reviews</p>
				</div>
				<div className="mt-10">
					<h3 className="text-lg font-medium text-gray-900">Give your feedback</h3>
					<p className="my-1 text-sm text-gray-600">
						If you’ve used this product, share you opinion.
					</p>
					<ReviewForm
